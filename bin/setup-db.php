...
$tables = [
    ...
    "CREATE TABLE IF NOT EXISTS taxonomy_terms (id BIGINT AUTO_INCREMENT PRIMARY KEY, taxonomy VARCHAR(64) NOT NULL, type VARCHAR(64) NOT NULL DEFAULT 'category', name VARCHAR(191) NOT NULL, slug VARCHAR(191) NOT NULL, parent_id BIGINT NULL, description TEXT NULL, color VARCHAR(16) NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, UNIQUE KEY unique_tax_slug (taxonomy, slug)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4",

...
('home', 'home', '{"hero_badge":"Stack 0.1.9 â€¢ Stable","hero_title":"The Lean, Mean, PHP Machine.","hero_subtitle":"Build blazingly fast systems with Tailwind, Alpine, Volt, and Phalcon. Thin, light, and engineered for the sub-millisecond era.","cta_primary":"Get Started","cta_secondary":"View Benchmarks","feature_1_title":"Lean Architecture","feature_1_desc":"A C-extension core runs your code close to the metal, while a Laravel-style ergonomic layer keeps development a joy.","feature_2_title":"Thin Core","feature_2_desc":"Modular by design. Load exactly what your application needs â€” nothing more.","feature_3_title":"High Throughput","feature_3_desc":"Thousands of requests per second on a modest 2-core VPS. Up to 12,000+ with the Coil runtime.","feature_4_title":"Low RAM Footprint","feature_4_desc":"Peak performance in under 15MB per worker â€” efficient enough for edge, containers, and modest boxes alike.","platforms_title":"Runs Where You Do","platforms_subtitle":"From the $5/mo VPS you already own to Docker and managed panels â€” TAVP feels right at home everywhere.","stat_1_label":"Response Time","stat_1_value":"<5ms","stat_1_desc":"P95 latency on a 2-core VPS with PHP-FPM.","stat_2_label":"Throughput","stat_2_value":"12,000+","stat_2_desc":"Requests per second with the Coil (Swoole) runtime.","stat_3_label":"Memory","stat_3_value":"<15MB","stat_3_desc":"Per worker, at peak performance.","cta_title":"Less config, more craft.","cta_highlight":"Start building your product.","cta_final_1_text":"Get Started","cta_final_2_text":"Documentation"}', 'published', NOW(), NOW());
...
('post', 'tavp-stack-php-tapi-cepat-pengantar-lengkap-ekosistem-arsitekturnya', '{"title":"TAVP Stack: PHP Tapi Cepat â€” Pengantar Lengkap Ekosistem & Arsitekturnya","excerpt":"TAVP Stack combines Tailwind, Alpine, Volt, and Phalcon for blazingly fast PHP applications.","body":"## Apa itu TAVP Stack?\\n\\nTAVP Stack adalah framework modern yang menggabungkan empat teknologi:\\n\\n- **Tailwind CSS** â€” utility-first CSS framework\\n- **Alpine.js** â€” JavaScript ringan untuk interaktivitas\\n- **Volt** â€” template engine dari Phalcon\\n- **Phalcon** â€” PHP C-extension framework\\n\\n## Mengapa TAVP?\\n\\nPerforma sub-milidetik dengan developer experience yang menyenangkan.","status":"published","author":"Jeremy Cheng"}', 'published', '2026-07-12 04:23:00', NOW(), NOW());

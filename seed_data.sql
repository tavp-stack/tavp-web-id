...
-- Seed posts
INSERT INTO contents (type, slug, data, status, published_at, created_at, updated_at) VALUES
...
-- Seed menus
INSERT INTO menus (name, slug, created_at, updated_at) VALUES ('Main Menu', 'main-menu', NOW(), NOW());

-- Seed analytics data
INSERT INTO analytics_page_visits (path, session_id, ip_address, device, browser, created_at) VALUES

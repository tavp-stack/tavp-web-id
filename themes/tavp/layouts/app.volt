...
<nav class="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-outline-variant">
  <div class="max-w-[1280px] mx-auto px-gutter h-16 flex justify-between items-center">
    ...
    <div class="flex items-center gap-6">
      ...
      <a href="<?= htmlspecialchars($layout['github_url'] ?? 'https://github.com/tavp-stack') ?>" class="text-on-surface hover:text-secondary transition-colors duration-200" aria-label="GitHub">
  ...
  <div class="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 gap-12">
      <div class="space-y-4">
        ...
        <ul class="space-y-2">
          <li><a class="font-body-md text-on-tertiary-container hover:text-on-surface transition-all" href="<?= htmlspecialchars($layout['footer_resource_1_url'] ?? 'https://docs.tavp.web.id/index.html') ?>"><?= htmlspecialchars($layout['footer_resource_1_text'] ?? 'Documentation') ?></a></li>
          <li><a class="font-body-md text-on-tertiary-container hover:text-on-surface transition-all" href="<?= htmlspecialchars($layout['footer_resource_2_url'] ?? '/performance') ?>"><?= htmlspecialchars($layout['footer_resource_2_text'] ?? 'Benchmarks') ?></a></li>
        </ul>
      </div>
      <div class="space-y-4">
        <h4 class="font-label-caps text-on-surface uppercase tracking-widest">Connect</h4>
        <ul class="space-y-2">
          <li><a class="font-body-md text-on-tertiary-container hover:text-on-surface transition-all" href="<?= htmlspecialchars($layout['footer_connect_1_url'] ?? 'https://github.com/tavp-stack') ?>"><?= htmlspecialchars($layout['footer_connect_1_text'] ?? 'GitHub') ?></a></li>
        </ul>
      </div>
    </div>
  </div>

  ...
  <div class="max-w-[1280px] mx-auto px-gutter h-16 flex justify-between items-center">
    ...
    <div class="flex items-center gap-6">
      ...
      <div class="hidden md:flex gap-6 items-center">
        ...
        <a class="text-sm text-on-surface-variant hover:text-secondary transition-colors duration-200" href="/get-started">Get Started</a>
  ...
  <div class="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 gap-12">
      <div class="space-y-4">
        ...
        <ul class="space-y-2">
          <li><a class="text-sm text-on-tertiary-container hover:text-on-surface transition-all" href="https://docs.tavp.web.id/index.html">Documentation</a></li>
          <li><a class="text-sm text-on-tertiary-container hover:text-on-surface transition-all" href="/performance">Benchmarks</a></li>
        </ul>
      </div>
      <div class="space-y-4">

...
<section class="relative py-24 overflow-hidden border-b border-outline-variant">
  <div class="max-w-[1280px] mx-auto px-gutter relative z-10">
    <div class="max-w-3xl">
      <h1 class="font-headline-xl text-headline-xl text-on-surface mb-6">Built for Bare Metal Speed.</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div class="lg:col-span-7 bg-surface-container p-8 rounded-xl performance-card-glow border border-outline-variant">
        <div class="flex justify-between items-start mb-10">
          <div>
            <h3 class="font-headline-lg text-on-surface">Throughput by Runtime</h3>
            <p class="text-on-surface-variant font-code-sm">Same code, four runtimes — pick your road (2-core VPS).</p>
          </div>
          <span class="material-symbols-outlined text-secondary text-4xl">bolt</span>
        </div>
        <div class="space-y-8">
          <div>
            <div class="flex justify-between mb-2"><span class="font-label-caps text-on-surface">TAVP COIL · SWOOLE</span><span class="font-code-sm text-secondary">12,000+ RPS</span></div>
          ...
          <div>
            <div class="flex justify-between mb-2"><span class="font-label-caps text-on-surface">TAVP RELAY · ROADRUNNER</span><span class="font-code-sm text-secondary">9,000+ RPS</span></div>
          ...
          <div>
            <div class="flex justify-between mb-2"><span class="font-label-caps text-on-surface">TAVP WEAVE · PHP FIBERS</span><span class="font-code-sm text-secondary">6,000+ RPS</span></div>
          ...
          <div>
            <div class="flex justify-between mb-2"><span class="font-label-caps text-on-surface">PHP-FPM · DEFAULT</span><span class="font-code-sm text-secondary">5,000+ RPS</span></div>
        ...
        <p class="mt-12 font-code-sm text-on-tertiary-container italic leading-tight">Only the runtime changes — zero code rewrite.</p>
      </div>
      ...
      <div class="lg:col-span-5 bg-primary-container p-8 rounded-xl border border-secondary/30 relative overflow-hidden group">
        ...
        <h3 class="font-headline-lg text-secondary mb-4">The "Low-End Box" Test</h3>
        <p class="text-on-surface mb-8">We ran TAVP on a modest VPS to show how far efficient architecture goes.</p>
        <div class="flex items-end gap-2 mb-2"><span class="font-headline-xl text-secondary">&lt;5ms</span><span class="font-label-caps text-on-surface-variant pb-2">P95 LATENCY</span></div>
        <p class="font-code-sm text-on-tertiary-container mb-10">Response time under typical concurrent load.</p>
        <div class="space-y-4">
          <div class="flex justify-between items-center py-3 border-b border-outline-variant"><span class="font-label-caps">Memory / Worker</span><span class="font-code-sm text-secondary">&lt;15 MB</span></div>
          <div class="flex justify-between items-center py-3 border-b border-outline-variant"><span class="font-label-caps">With Coil</span><span class="font-code-sm text-secondary">&lt;8 MB</span></div>
          <div class="flex justify-between items-center py-3 border-b border-outline-variant"><span class="font-label-caps">Concurrent</span><span class="font-code-sm text-secondary">5,000+</span></div>
        </div>
      </div>
      ...
      <div class="lg:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
        <div class="bg-surface-container p-8 rounded-xl border border-outline-variant">
          <div class="flex items-center gap-4 mb-6"><span class="material-symbols-outlined text-secondary">analytics</span><h4 class="font-headline-lg text-on-surface">Memory Per Worker</h4></div>
          <div class="h-64 relative flex items-end justify-around gap-4 px-4 border-b border-outline-variant">
            <div class="flex flex-col items-center w-full max-w-[80px]"><div class="bg-secondary w-full rounded-t-lg transition-all duration-1000 delay-300" style="height: 52%;"></div><span class="font-code-sm text-secondary mt-2">&lt;8MB</span><span class="font-label-caps mt-1">Coil</span></div>
            <div class="flex flex-col items-center w-full max-w-[80px]"><div class="bg-secondary w-full rounded-t-lg transition-all duration-1000 delay-300" style="height: 100%;"></div><span class="font-code-sm text-secondary mt-2">&lt;15MB</span><span class="font-label-caps mt-1">PHP-FPM</span></div>
          </div>
        ...
        <div class="bg-surface-container-high p-8 rounded-xl border border-outline-variant flex flex-col justify-center">
          <h4 class="font-headline-lg text-on-surface mb-6">Why It's Fast</h4>
          <ul class="space-y-4">
  ...
  <div class="max-w-[1280px] mx-auto px-gutter grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    <div>
      <div class="inline-flex items-center px-3 py-1 bg-secondary/10 border border-secondary/30 rounded-full mb-6">
        ...
        <span class="font-label-caps text-secondary">Architecture Focus</span>
      </div>
      <h2 class="font-headline-xl text-on-surface mb-6">Leaner Internals,<br/>Faster Deployment.</h2>
      ...
      <div class="p-6 bg-background rounded-lg border border-outline-variant font-code-sm">

...
<div class="pt-16 pb-20 px-6 md:px-12 max-w-[1280px] mx-auto">
  ...
  <header class="mb-16">
    <div class="inline-flex items-center gap-2 px-3 py-1 bg-primary-container text-secondary font-label-caps text-label-caps border border-secondary/30 rounded-full mb-6">
    ...
    <h1 class="font-headline-xl text-headline-xl mb-4">Installation Guide</h1>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
    <div class="lg:col-span-8 space-y-16">
      ...
      <section class="relative pl-12 border-l border-outline-variant">
        <div class="absolute -left-6 top-0 w-12 h-12 bg-surface-container border border-outline-variant flex items-center justify-center font-headline-lg text-headline-lg step-number">1</div>
        <div class="mb-6">
          <h2 class="font-headline-lg text-headline-lg text-on-surface mb-2">Install the Phalcon Extension</h2>
      ...
      {# Step 2 #}
      <section class="relative pl-12 border-l border-outline-variant">
        <div class="absolute -left-6 top-0 w-12 h-12 bg-surface-container border border-outline-variant flex items-center justify-center font-headline-lg text-headline-lg step-number">2</div>
        <div class="mb-6">
          <h2 class="font-headline-lg text-headline-lg text-on-surface mb-2">Create Your Project</h2>
          <p class="text-on-tertiary-container">Bootstrap a new app with Composer, then start the development server.</p>
        </div>
        <div class="rounded-lg overflow-hidden border border-outline-variant code-glow">
          <div class="bg-surface-container px-4 py-2 flex justify-between items-center border-b border-outline-variant">
            <span class="font-label-caps text-label-caps text-on-tertiary-container">BASH</span>
            <span class="material-symbols-outlined text-on-tertiary-container text-sm">content_copy</span>
          </div>
          <div class="p-4 font-code-sm text-code-sm bg-background">
            <code class="block">
      ...
      <section class="relative pl-12 border-l border-outline-variant">
        ...
        <div class="mb-6">
          <h2 class="font-headline-lg text-headline-lg text-on-surface mb-2">Tailwind &amp; Alpine</h2>
        ...
        <div class="rounded-lg overflow-hidden border border-outline-variant code-glow">
          <div class="bg-surface-container px-4 py-2 flex justify-between items-center border-b border-outline-variant">
            <span class="font-label-caps text-label-caps text-on-tertiary-container">NPM</span>
            <span class="material-symbols-outlined text-on-tertiary-container text-sm">content_copy</span>
          </div>
          <div class="p-4 font-code-sm text-code-sm bg-background">
            <code class="block">
      ...
      <section class="mt-24 p-8 bg-surface-container-low border-2 border-secondary/20 rounded-xl">
        <div class="flex items-center gap-3 mb-8">
          ...
          <h2 class="font-headline-lg text-headline-lg">Hello World in Volt</h2>
        </div>
        ...
        <div class="rounded-lg overflow-hidden border border-outline-variant code-glow bg-background">
          <div class="bg-surface-container-high px-4 py-2 border-b border-outline-variant flex items-center gap-2">
            ...
            <span class="ml-auto font-label-caps text-label-caps text-on-tertiary-container">views/index.volt</span>
          </div>
          <div class="p-6 font-code-sm text-code-sm">
      ...
      <div class="sticky top-24 space-y-8">
        <div class="p-6 bg-surface-container rounded-xl border-t-2 border-secondary">
          <div class="flex items-center gap-3 mb-4">
            ...
            <h3 class="font-headline-lg text-[20px] font-bold">VPS Optimization</h3>
          </div>

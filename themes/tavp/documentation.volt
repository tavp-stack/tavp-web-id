...
<div class="max-w-[1280px] mx-auto flex">
  ...
  <aside class="hidden md:block w-64 sticky top-16 h-[calc(100vh-4rem)] border-r border-outline-variant overflow-y-auto pt-8 px-gutter">
    <div class="space-y-8">
      <div>
        <h5 class="text-xs font-semibold uppercase tracking-widest text-label-caps text-on-tertiary-container mb-4 uppercase tracking-widest">Introduction</h5>
        <ul class="space-y-2">
      ...
      <div>
        <h5 class="text-xs font-semibold uppercase tracking-widest text-label-caps text-on-tertiary-container mb-4 uppercase tracking-widest">Components</h5>
        <ul class="space-y-2">
      ...
      <div>
        <h5 class="text-xs font-semibold uppercase tracking-widest text-label-caps text-on-tertiary-container mb-4 uppercase tracking-widest">Advanced</h5>
        <ul class="space-y-2">
  ...
  <main class="flex-1 md:pl-12 px-gutter py-12">
    <div class="max-w-3xl">
      <nav class="flex items-center gap-2 mb-8 text-on-tertiary-container font-mono text-sm text-code-sm">
        <span>Docs</span>

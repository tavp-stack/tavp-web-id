...
<div class="max-w-[1280px] mx-auto flex">
  ...
  <main class="flex-1 md:pl-12 px-gutter py-12">
    <div class="max-w-3xl">
      <nav class="flex items-center gap-2 mb-8 text-on-tertiary-container font-code-sm text-code-sm">
        <span>Docs</span>
      ...
      <header class="mb-12 relative overflow-hidden p-8 bg-surface-container rounded-xl border border-outline-variant">
        <div class="relative z-10">
          <h1 class="font-headline-xl text-headline-xl mb-4">Introduction to the <span class="text-secondary">TAVP</span> Stack</h1>
      ...
      {# Core components #}
      <section class="mb-16">
        <h2 class="font-headline-lg text-headline-lg mb-8 border-b-2 border-surface-variant pb-2">Core Components</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="performance-card bg-surface-container p-6 rounded-xl border border-outline-variant border-t-2 border-t-secondary">
            <div class="flex items-center gap-3 mb-4"><span class="w-10 h-10 flex items-center justify-center bg-secondary-container text-on-secondary rounded font-bold font-code-sm">T</span><h3 class="font-headline-lg text-xl">Tailwind CSS</h3></div>
            ...
            <div class="code-block p-3 rounded font-code-sm text-code-sm text-on-tertiary-container"><span class="text-secondary">class</span>=<span class="text-on-surface">"flex gap-4 items-center"</span></div>
          </div>
          <div class="performance-card bg-surface-container p-6 rounded-xl border border-outline-variant border-t-2 border-t-secondary">
            <div class="flex items-center gap-3 mb-4"><span class="w-10 h-10 flex items-center justify-center bg-secondary-container text-on-secondary rounded font-bold font-code-sm">A</span><h3 class="font-headline-lg text-xl">Alpine.js</h3></div>
            ...
            <div class="code-block p-3 rounded font-code-sm text-code-sm text-on-tertiary-container"><span class="text-secondary">x-data</span>=<span class="text-on-surface">"{ open: false }"</span></div>
          </div>
          <div class="performance-card bg-surface-container p-6 rounded-xl border border-outline-variant border-t-2 border-t-secondary">
            <div class="flex items-center gap-3 mb-4"><span class="w-10 h-10 flex items-center justify-center bg-secondary-container text-on-secondary rounded font-bold font-code-sm">V</span><h3 class="font-headline-lg text-xl">Volt Templates</h3></div>
            ...
            <div class="code-block p-3 rounded font-code-sm text-code-sm text-on-tertiary-container">&#123;&#123; <span class="text-secondary">content()</span> &#125;&#125;</div>
          </div>
          <div class="performance-card bg-surface-container p-6 rounded-xl border border-outline-variant border-t-2 border-t-secondary">
            <div class="flex items-center gap-3 mb-4"><span class="w-10 h-10 flex items-center justify-center bg-secondary-container text-on-secondary rounded font-bold font-code-sm">P</span><h3 class="font-headline-lg text-xl">Phalcon PHP</h3></div>
            ...
            <div class="code-block p-3 rounded font-code-sm text-code-sm text-on-tertiary-container"><span class="text-secondary">$app</span>-&gt;<span class="text-on-surface">handle()</span>;</div>
          </div>
        </div>
      </section>
      ...
      {# Lean philosophy #}
      <section class="mb-16">
        <h2 class="font-headline-lg text-headline-lg mb-8 border-b-2 border-surface-variant pb-2">The 'Lean' Philosophy</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="space-y-4"><span class="material-symbols-outlined text-secondary text-4xl">speed</span><h4 class="font-headline-lg text-lg">Maximum Speed</h4><p class="text-body-md text-on-tertiary-container">Phalcon's C-extension keeps backend response times low and predictable.</p></div>
          <div class="space-y-4"><span class="material-symbols-outlined text-secondary text-4xl">layers_clear</span><h4 class="font-headline-lg text-lg">Zero Bloat</h4><p class="text-body-md text-on-tertiary-container">Ship only what the page needs. Lightweight by default, no heavy runtime.</p></div>
          <div class="space-y-4"><span class="material-symbols-outlined text-secondary text-4xl">developer_mode</span><h4 class="font-headline-lg text-lg">Tooling Unity</h4><p class="text-body-md text-on-tertiary-container">One coherent stack for styling, behavior, and logic — productive end to end.</p></div>
        </div>
      </section>
      ...
      <section class="mb-16">
        <div class="relative rounded-xl overflow-hidden border border-outline-variant p-10 bg-surface-container-low">
          ...
          <div class="relative z-10">
            <p class="font-label-caps text-label-caps text-secondary mb-1">Four runtimes, one codebase</p>
            <h3 class="font-headline-lg text-2xl mb-3">Pick the road that fits your deploy.</h3>
      ...
      <section class="mb-16 p-8 bg-surface-container-low rounded-xl border border-outline-variant border-l-4 border-l-secondary">
        <div class="flex items-start gap-4">
          ...
          <div>
            <h2 class="font-headline-lg text-2xl mb-4">Open Source License</h2>
